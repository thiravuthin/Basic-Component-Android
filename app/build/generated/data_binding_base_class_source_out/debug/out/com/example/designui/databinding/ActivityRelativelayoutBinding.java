...
public final class ActivityRelativelayoutBinding implements ViewBinding {
  ...
  private ActivityRelativelayoutBinding(@NonNull RelativeLayout rootView,
  ...
  public static ActivityRelativelayoutBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_relativelayout, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static ActivityRelativelayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityRelativelayoutBinding((RelativeLayout) rootView, txtFirst);
    }
