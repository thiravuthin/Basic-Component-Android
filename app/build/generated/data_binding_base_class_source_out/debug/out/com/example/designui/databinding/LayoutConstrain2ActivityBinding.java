...
public final class LayoutConstrain2ActivityBinding implements ViewBinding {
  @NonNull
  ...
  private LayoutConstrain2ActivityBinding(@NonNull ConstraintLayout rootView, @NonNull View divider,
  ...
  @NonNull
  public static LayoutConstrain2ActivityBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutConstrain2ActivityBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_constrain2_activity, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutConstrain2ActivityBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutConstrain2ActivityBinding((ConstraintLayout) rootView, divider, divider2,
