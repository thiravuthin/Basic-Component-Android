...
public final class ActivityPracticeBinding implements ViewBinding {
  ...
  private ActivityPracticeBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnSum,
      @NonNull EditText editText3, @NonNull EditText editText4, @NonNull TextView txtLabel1,
      @NonNull TextView txtLabel2, @NonNull TextView txtResult) {
  ...
  public static ActivityPracticeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityPracticeBinding((ConstraintLayout) rootView, btnSum, editText3, editText4,
          txtLabel1, txtLabel2, txtResult);
    }
