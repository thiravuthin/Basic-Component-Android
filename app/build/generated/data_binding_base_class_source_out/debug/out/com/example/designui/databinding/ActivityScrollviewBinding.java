...
public final class ActivityScrollviewBinding implements ViewBinding {
  ...
  private ActivityScrollviewBinding(@NonNull ConstraintLayout rootView) {
  ...
  public static ActivityScrollviewBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_scrollview, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static ActivityScrollviewBinding bind(@NonNull View rootView) {
    ...
    return new ActivityScrollviewBinding((ConstraintLayout) rootView);
  }
}
