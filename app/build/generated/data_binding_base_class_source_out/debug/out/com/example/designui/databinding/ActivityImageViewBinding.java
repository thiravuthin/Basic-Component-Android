...
public final class ActivityImageViewBinding implements ViewBinding {
  ...
  private ActivityImageViewBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView img1) {
  ...
  public static ActivityImageViewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityImageViewBinding((ConstraintLayout) rootView, img1);
    }
