...
public final class AnimationActivityBinding implements ViewBinding {
  @NonNull
  ...
  private AnimationActivityBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static AnimationActivityBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AnimationActivityBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.animation_activity, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AnimationActivityBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AnimationActivityBinding((ConstraintLayout) rootView, btnPlayAnimation,
          txtAnimation);
    }
