...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull RelativeLayout rootView, @NonNull ImageButton btnFacebook,
      @NonNull ImageButton btnGoogle, @NonNull Button btnLogin, @NonNull ImageButton btnSwing,
      @NonNull EditText editTextUsername, @NonNull EditText editTextpassword,
      @NonNull TextView txtForgotpassword, @NonNull TextView txtLogin,
      @NonNull TextView txtPassword, @NonNull TextView txtSigUp, @NonNull TextView txtSignup,
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((RelativeLayout) rootView, btnFacebook, btnGoogle, btnLogin,
          btnSwing, editTextUsername, editTextpassword, txtForgotpassword, txtLogin, txtPassword,
          txtSigUp, txtSignup, txtUsername);
    }
